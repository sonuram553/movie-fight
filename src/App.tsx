      ...
      <main>
        ...
        {showHint && (
          <div className="mx-auto mt-16 max-w-lg rounded-xl border border-teal-100 bg-teal-50 px-8 py-6 text-center shadow-sm">
            <h2 className="text-lg font-semibold text-teal-700">How to compare movies</h2>
            <p className="mt-2 text-sm text-teal-600">
              Use the search boxes above to find a movie on each side. Click a result from the
              dropdown to load its details. Once both sides have a movie selected, stats are
              compared automatically — the lower value is highlighted in{" "}
              <span className="font-semibold text-yellow-500">yellow</span> and the higher in{" "}
